...
let stocksTickerName = ["AARTIIND","ABBOTINDIA","ABFRL","ACC","ADANIENT","ADANIPORTS","ALKEM","AMARAJABAT","AMBUJACEM","APLLTD","APOLLOHOSP","APOLLOTYRE",
...
app.get("/api/getStockData", (req, resp) => {
    ...
    stocksUtil.getStockDataByTicker(ticker)
        .then(data => {
            resp.status(200).json(data.Items)
        })
        .catch(error => {
